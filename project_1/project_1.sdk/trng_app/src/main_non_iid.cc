...
int main(){
	...
	///////////// In the following part a 1M random bits are generated in the FPGA and statistical tests are performed in ARM ////////////////
	...
	while(run_again){
		...
		// The counter runs 31 times to generate 31*64*512 bits which is roughly 1M.
		// The bits are stored in data[ ] for performing NIST tests
		...
		printf("Final min-entropy after all NIST tests in SW = %lf\n", min_entropy);
